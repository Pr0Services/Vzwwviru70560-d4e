 ...
 * â•‘                                                                                        â•‘
 * â•‘  ðŸ”¥ THE ULTIMATE AI-POWERED COMMAND CENTER ðŸ”¥                                          â•‘
 ...
 * â•‘  ðŸ§  AI Smart Suggestions          ðŸŽ¤ Voice Input                                       â•‘
 * â•‘  ðŸ“Š Activity Timeline             â­ Smart Favorites                                   â•‘
 * â•‘  ðŸ• Command History               ðŸ”— Quick Links                                       â•‘
 * â•‘  ðŸ“‹ Clipboard Integration         ðŸŽ¨ Theme Switcher                                    â•‘
 * â•‘  ðŸ§® Calculator Mode               ðŸŒ Multi-language (FR/EN/ES)                         â•‘
 * â•‘  âŒ¨ï¸ Vim-style Navigation          ðŸ‘ï¸ Live Preview                                      â•‘
 * â•‘  ðŸ“ˆ Usage Analytics               ðŸŽ¯ Context Awareness                                 â•‘
 * â•‘  ðŸ—‚ï¸ Category Browser              ðŸ“¦ Module Launcher                                   â•‘
 * â•‘                                                                                        â•‘
...
const UNIVERSAL_ACTIONS = [
  { id: 'CREER', icon: 'âž•', label: 'CrÃ©er', sublabel: 'Nouveau Ã©lÃ©ment', shortcut: 'N', color: '#4ade80' },
  { id: 'MODIFIER', icon: 'âœï¸', label: 'Modifier', sublabel: 'Ã‰diter existant', shortcut: 'E', color: '#f59e0b' },
  ...
  { id: 'ANALYSER', icon: 'ðŸ“Š', label: 'Analyser', sublabel: 'Statistiques & insights', shortcut: 'A', color: '#06b6d4' },
  { id: 'PUBLIER', icon: 'ðŸš€', label: 'Publier', sublabel: 'Partager publiquement', shortcut: 'P', color: '#ec4899' },
];
...
const MODULE_META: Record<string, { icon: string; label: string }> = {
  ...
  TRACKING_HABITUDES: { icon: 'ðŸ“ˆ', label: 'Suivi des habitudes' },
  SUIVI_SANTE: { icon: 'â¤ï¸', label: 'Suivi santÃ©' },
  BUDGET: { icon: 'ðŸ’°', label: 'Budget' },
  DEPENSES: { icon: 'ðŸ’¸', label: 'DÃ©penses' },
  OBJECTIFS: { icon: 'ðŸŽ¯', label: 'Objectifs' },
  
  // Social
  FEED: { icon: 'ðŸ“±', label: 'Feed' },
  MESSAGES: { icon: 'ðŸ’¬', label: 'Messages' },
  VIDEOS: { icon: 'ðŸŽ¬', label: 'VidÃ©os' },
  MUSIQUE: { icon: 'ðŸŽµ', label: 'Musique' },
  JEUX: { icon: 'ðŸŽ®', label: 'Jeux' },
  
  // Scholar
  LISTE_COURS: { icon: 'ðŸ“š', label: 'Liste des cours' },
  PLANNING: { icon: 'ðŸ“…', label: 'Planning' },
  FLASHCARDS: { icon: 'ðŸƒ', label: 'Flashcards' },
  RESUMES: { icon: 'ðŸ“', label: 'RÃ©sumÃ©s' },
  PLANS_REVISION: { icon: 'ðŸ“‹', label: 'Plans de rÃ©vision' },
  CALENDRIER_EXAMENS: { icon: 'ðŸ“†', label: 'Calendrier examens' },
  RESULTATS: { icon: 'ðŸ†', label: 'RÃ©sultats' },
  
  // Maison
  TACHES_MAISON: { icon: 'ðŸ§¹', label: 'TÃ¢ches maison' },
  CALENDRIER_MAISON: { icon: 'ðŸ“…', label: 'Calendrier maison' },
  CONTACTS_FAMILLE: { icon: 'ðŸ‘¨â€ðŸ‘©â€ðŸ‘§', label: 'Contacts famille' },
  NOTES_FAMILLE: { icon: 'ðŸ“', label: 'Notes famille' },
  
  // Entreprise
  PROJETS_ENTREPRISE: { icon: 'ðŸ“', label: 'Projets entreprise' },
  PROCESSUS: { icon: 'âš™ï¸', label: 'Processus' },
  COMPTES: { icon: 'ðŸ¦', label: 'Comptes' },
  FACTURES: { icon: 'ðŸ§¾', label: 'Factures' },
  RAPPORTS: { icon: 'ðŸ“Š', label: 'Rapports' },
  CRM: { icon: 'ðŸ‘¥', label: 'CRM' },
  PIPELINE: { icon: 'ðŸ“ˆ', label: 'Pipeline' },
  SUIVI_CLIENT: { icon: 'ðŸ¤', label: 'Suivi client' },
  
  // Projets
  TACHES: { icon: 'âœ…', label: 'TÃ¢ches' },
  KANBAN: { icon: 'ðŸ“‹', label: 'Kanban' },
  DOCS_PROJET: { icon: 'ðŸ“„', label: 'Documents projet' },
  DISCUSSION: { icon: 'ðŸ’¬', label: 'Discussion' },
  STREAMING_PROJET: { icon: 'ðŸ“º', label: 'Streaming projet' },
  
  // Creative
  PROJETS_MEDIA: { icon: 'ðŸŽ¬', label: 'Projets mÃ©dia' },
  TIMELINE_MEDIA: { icon: 'ðŸŽžï¸', label: 'Timeline mÃ©dia' },
  TEMPLATES_VISUELS: { icon: 'ðŸ–¼ï¸', label: 'Templates visuels' },
  KITS_BRAND: { icon: 'ðŸŽ¨', label: 'Kits brand' },
  
  // Gouvernement
  DOCS_IDENTITE: { icon: 'ðŸªª', label: 'Documents identitÃ©' },
  DOSSIERS_OFFICIELS: { icon: 'ðŸ“', label: 'Dossiers officiels' },
  DECLARATIONS: { icon: 'ðŸ“', label: 'DÃ©clarations' },
  HISTORIQUE_PAIEMENTS: { icon: 'ðŸ’³', label: 'Historique paiements' },
  DEMANDES: { icon: 'ðŸ“¨', label: 'Demandes' },
  PERMIS_ACTIFS: { icon: 'âœ…', label: 'Permis actifs' },
  
  // Immobilier
  LISTE_PROPRIETES: { icon: 'ðŸ˜ï¸', label: 'Liste propriÃ©tÃ©s' },
  DETAIL_PROPRIETE: { icon: 'ðŸ ', label: 'DÃ©tail propriÃ©tÃ©' },
  BAUX: { icon: 'ðŸ“œ', label: 'Baux' },
  ACTES: { icon: 'ðŸ“„', label: 'Actes' },
  ASSURANCES: { icon: 'ðŸ›¡ï¸', label: 'Assurances' },
  RENTABILITE: { icon: 'ðŸ’¹', label: 'RentabilitÃ©' },
  CASHFLOW: { icon: 'ðŸ’µ', label: 'Cashflow' },
  SIMULATIONS: { icon: 'ðŸ”®', label: 'Simulations' },
  
  // Associations
  FEED_ASSOCIATION: { icon: 'ðŸ“±', label: 'Feed association' },
  MEMBRES: { icon: 'ðŸ‘¥', label: 'Membres' },
  PROJETS_ASSOC: { icon: 'ðŸ“', label: 'Projets association' },
  DOCS_ASSOC: { icon: 'ðŸ“„', label: 'Documents association' },
};
...
const buildModules = (spaceId: string, categoryId: string): HubItem[] => {
  ...
  return category.modules.map(moduleId => {
    const meta = MODULE_META[moduleId] || { icon: 'ðŸ“¦', label: moduleId };
    return {
...
const NOVA_COMMANDS: HubItem[] = [
  { id: 'nova-ask', type: 'nova', icon: 'ðŸ’¬', label: 'Demander Ã  Nova', sublabel: 'Question libre', keywords: ['ask', 'question'] },
  { id: 'nova-summarize', type: 'nova', icon: 'ðŸ“‹', label: 'RÃ©sumer', sublabel: 'Page actuelle', keywords: ['summary', 'tldr'] },
  { id: 'nova-analyze', type: 'nova', icon: 'ðŸ“Š', label: 'Analyser', sublabel: 'DonnÃ©es & insights', keywords: ['analyze', 'data'] },
  { id: 'nova-translate', type: 'nova', icon: 'ðŸŒ', label: 'Traduire', sublabel: 'FR/EN/ES/DE', keywords: ['translate'] },
  { id: 'nova-write', type: 'nova', icon: 'âœï¸', label: 'RÃ©diger', sublabel: 'Aide rÃ©daction', keywords: ['write', 'draft'] },
  { id: 'nova-schedule', type: 'nova', icon: 'ðŸ“…', label: 'Planifier', sublabel: 'Organiser agenda', keywords: ['schedule', 'plan'] },
  { id: 'nova-remind', type: 'nova', icon: 'â°', label: 'Rappel', sublabel: 'CrÃ©er rappel', keywords: ['remind', 'alert'] },
  { id: 'nova-code', type: 'nova', icon: 'ðŸ’»', label: 'Code Helper', sublabel: 'Dev assistance', keywords: ['code', 'dev'] },
  { id: 'nova-image', type: 'nova', icon: 'ðŸŽ¨', label: 'GÃ©nÃ©rer Image', sublabel: 'IA crÃ©ative', keywords: ['image', 'generate'] },
  { id: 'nova-search', type: 'nova', icon: 'ðŸ”', label: 'Recherche Web', sublabel: 'Internet search', keywords: ['search', 'web'] },
];
...
const THEMES: HubItem[] = [
  { id: 'theme-dark', type: 'theme', icon: 'ðŸŒ™', label: 'Sombre', sublabel: 'DÃ©faut', color: '#1E242C' },
  { id: 'theme-light', type: 'theme', icon: 'â˜€ï¸', label: 'Clair', sublabel: 'Mode jour', color: '#F4F0EB' },
  { id: 'theme-vr', type: 'theme', icon: 'ðŸ¥½', label: 'VR Mode', sublabel: 'NÃ©on', color: '#00ff88' },
...
const RECENT_ACTIVITY: HubItem[] = [
  { id: 'recent-1', type: 'recent', icon: 'ðŸ“', label: 'Projet Tremblay', sublabel: 'Il y a 5 min', path: '/projets/gestion_projet/taches', color: CHENU_CONFIG.PROJETS.color },
  { id: 'recent-2', type: 'recent', icon: 'ðŸ§¾', label: 'Facture #2024-089', sublabel: 'Il y a 12 min', path: '/entreprise/finances/factures', color: CHENU_CONFIG.ENTREPRISE.color },
  { id: 'recent-3', type: 'recent', icon: 'ðŸŽ“', label: 'Cours Python', sublabel: 'Il y a 1h', path: '/scholar/cours/liste_cours', color: CHENU_CONFIG.SCHOLAR.color },
  { id: 'recent-4', type: 'recent', icon: 'ðŸ ', label: 'TÃ¢ches maison', sublabel: 'Il y a 2h', path: '/maison/organisation/taches_maison', color: CHENU_CONFIG.MAISON.color },
];
...
const UnifiedNavigationHubProV2: React.FC<{
  ...
  const filteredResults = useMemo((): HubItem[] | null => {
    ...
    // Calculator
    if (calculatorResult) {
      return [{ id: 'calc', type: 'calculator', icon: 'ðŸ§®', label: calculatorResult, sublabel: `= ${query}`, shortcut: 'â†µ Copier' }];
    }
  ...
  const getModeInfo = () => {
    switch (mode) {
      case 'nova': return { icon: 'ðŸ¤–', label: 'Nova AI', color: '#a78bfa' };
      case 'create': return { icon: 'âž•', label: 'CrÃ©er', color: '#4ade80' };
      case 'goto': return { icon: 'ðŸš€', label: 'Aller Ã ', color: '#3b82f6' };
      case 'calculator': return { icon: 'ðŸ§®', label: 'Calculatrice', color: '#f59e0b' };
      case 'theme': return { icon: 'ðŸŽ¨', label: 'ThÃ¨mes', color: '#ec4899' };
      case 'browse': return { icon: 'ðŸ—‚ï¸', label: 'Explorer', color: '#06b6d4' };
      case 'action': return { icon: 'âš¡', label: `Action: ${selectedAction}`, color: '#f59e0b' };
      default: return { icon: 'ðŸ”', label: 'Rechercher', color: tokens.colors.gold };
    }
  };
      ...
      <div style={styles.modal} onClick={e => e.stopPropagation()}>
        ...
        <div style={styles.header}>
          ...
          <div style={{ ...styles.searchContainer, borderColor: modeInfo.color, boxShadow: `0 0 20px ${modeInfo.color}30` }}>
            ...
            />
            <button onClick={() => setIsListening(!isListening)} style={{ ...styles.voiceBtn, backgroundColor: isListening ? '#ef4444' : 'transparent' }}>ðŸŽ¤</button>
          ...
          <div style={styles.modePills}>
            {[
              { m: 'default', label: 'ðŸ” Tout' },
              { m: 'browse', label: 'ðŸ—‚ï¸ Explorer' },
              { m: 'create', label: 'âž• CrÃ©er', trigger: '/' },
              { m: 'nova', label: 'ðŸ¤– Nova', trigger: '@' },
            ].map(p => (
              <button
                key={p.m}
        ...
        <div ref={listRef} style={styles.content}>
          ...
          {calculatorResult && (
            <div style={styles.calcResult}>
              ...
              <button onClick={() => { navigator.clipboard?.writeText(calculatorResult); onClose(); }} style={styles.calcCopy}>ðŸ“‹ Copier</button>
            </div>
          )}
          ...
          {!filteredResults && !calculatorResult && (
            <>
              {/* Recent */}
              <div style={styles.section}>
                <div style={styles.sectionHeader}><span>ðŸ•</span><span>RÃ©cent</span></div>
                <div style={styles.list}>
              ...
              {/* 10 Spaces Grid */}
              <div style={styles.section}>
                <div style={styles.sectionHeader}><span>ðŸŒ</span><span>10 Espaces CHEÂ·NU</span></div>
    ...
    <div style={{ minHeight: '100vh', backgroundColor: tokens.colors.bg.void, padding: 32, fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 48 }}>
        <div style={{ display: 'inline-block', padding: '4px 14px', background: `linear-gradient(135deg, ${tokens.colors.gold}40, ${tokens.colors.turquoise}40)`, borderRadius: 20, fontSize: 12, color: tokens.colors.gold, fontWeight: 600, marginBottom: 16 }}>
          ðŸ”¥ VERSION PRO V2 - ARCHITECTURE OFFICIELLE
        </div>
        <h1 style={{ color: tokens.colors.text.primary, fontSize: 40, marginBottom: 12, background: `linear-gradient(135deg, ${tokens.colors.gold}, ${tokens.colors.turquoise})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
          ðŸš€ Unified Navigation Hub PRO V2
        </h1>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <h2 style={{ color: tokens.colors.text.primary, fontSize: 20, marginBottom: 20, textAlign: 'center' }}>ðŸŒ Les 10 Espaces CHEÂ·NU</h2>
