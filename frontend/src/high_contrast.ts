/* =========================================
   CHEÂ·NU â€” HIGH CONTRAST THEME
   
   ThÃ¨me accessible avec contraste Ã©levÃ©.
   Conforme WCAG AAA.
   ========================================= */
...
export const highContrastTheme: ThemeConfig = {
  id: 'high_contrast',
  name: 'High Contrast',
  description: 'ThÃ¨me accessible avec contraste Ã©levÃ© (WCAG AAA)',
