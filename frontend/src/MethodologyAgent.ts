/* =====================================================
   CHEÂ·NU â€” Methodology Analyst Agent
...
export class MethodologyAgent extends BaseAgent {
  ...
  private selectMethodology(
    ...
    // Deep focus pattern â†’ maintain or enhance
    ...
    // Context switching â†’ recommend sequential
    ...
    // Scattered work â†’ recommend focused or parallel
    ...
    // Good parallel progress â†’ maintain
    ...
    // Low completion rate â†’ recommend sequential
