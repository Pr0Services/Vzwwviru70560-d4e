 ...
 * /spheres/<sphere_id>/
 *  â”œâ”€ sphere.yaml
 *  â”œâ”€ sphere.manifest.md
 *  â”œâ”€ sphere.validation.json
 *  â””â”€ README.md
 */
...
function generateSphereYaml(sphere: GeneratedSphere): string {
  return `# CHEÂ·NU â€” Sphere Definition
...
| Protection | Status |
|------------|--------|
| Foundation inheritance | âœ… Enforced |
| Privacy inheritance | âœ… Enforced |
| Human data ownership | âœ… Enforced |
| Private by default | âœ… Enforced |
| Reversibility | âœ… Enabled |
| No urgency patterns | âœ… Enforced |
...
*Generated by CHEÂ·NU Sphere Generator*
`;
}
...
- âœ… Human data ownership
- âœ… Reversibility
- âœ… No behavioral optimization
