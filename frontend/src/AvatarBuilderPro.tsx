...
const AVATAR_STYLES = [
  { id: 'human', name: 'Humain RÃ©aliste', icon: 'ðŸ‘¤', description: 'Style professionnel rÃ©aliste', gradient: 'linear-gradient(135deg, #667eea, #764ba2)' },
  { id: 'cartoon', name: 'Cartoon', icon: 'ðŸŽ¨', description: 'Style animÃ© colorÃ©', gradient: 'linear-gradient(135deg, #f093fb, #f5576c)' },
  { id: 'animal', name: 'Animal', icon: 'ðŸ¾', description: 'Personnages animaliers', gradient: 'linear-gradient(135deg, #4facfe, #00f2fe)' },
  { id: 'mythic', name: 'Mythique', icon: 'ðŸ‰', description: 'CrÃ©atures fantastiques', gradient: 'linear-gradient(135deg, #fa709a, #fee140)' },
  { id: 'abstract3d', name: '3D Abstrait', icon: 'ðŸ”®', description: 'Formes gÃ©omÃ©triques 3D', gradient: 'linear-gradient(135deg, #a8edea, #fed6e3)' },
...
const HAIR_STYLES = [
  { id: 'short', name: 'Court', icon: 'ðŸ’‡', paths: 'short' },
  { id: 'medium', name: 'Mi-long', icon: 'ðŸ’‡â€â™€ï¸', paths: 'medium' },
  { id: 'long', name: 'Long', icon: 'ðŸ‘©â€ðŸ¦°', paths: 'long' },
  { id: 'curly', name: 'BouclÃ©', icon: 'ðŸ‘¨â€ðŸ¦±', paths: 'curly' },
  { id: 'wavy', name: 'OndulÃ©', icon: 'ðŸŒŠ', paths: 'wavy' },
  { id: 'afro', name: 'Afro', icon: 'ðŸ§‘â€ðŸ¦±', paths: 'afro' },
  { id: 'mohawk', name: 'Mohawk', icon: 'ðŸ§‘â€ðŸŽ¤', paths: 'mohawk' },
  { id: 'bun', name: 'Chignon', icon: 'ðŸ‘©â€ðŸ¦³', paths: 'bun' },
  { id: 'braids', name: 'Tresses', icon: 'ðŸ‘§', paths: 'braids' },
  { id: 'bald', name: 'Chauve', icon: 'ðŸ‘¨â€ðŸ¦²', paths: 'none' }
];
...
const EYE_SHAPES = [
  { id: 'almond', name: 'Amande', icon: 'ðŸ‘ï¸' },
  { id: 'round', name: 'Rond', icon: 'â­•' },
  { id: 'hooded', name: 'CapuchonnÃ©', icon: 'ðŸŒ™' },
  { id: 'monolid', name: 'Monolide', icon: 'âž–' },
...
const MOUTH_TYPES = [
  { id: 'full', name: 'Pulpeuses', icon: 'ðŸ’‹' },
  { id: 'thin', name: 'Fines', icon: 'âž–' },
...
const EXPRESSIONS = [
  { id: 'neutral', name: 'Neutre', icon: 'ðŸ˜', eyebrows: 'neutral', eyes: 'open', mouth: 'closed' },
  { id: 'happy', name: 'Joyeux', icon: 'ðŸ˜Š', eyebrows: 'raised', eyes: 'squint', mouth: 'smile' },
  { id: 'confident', name: 'Confiant', icon: 'ðŸ˜Ž', eyebrows: 'raised_one', eyes: 'half', mouth: 'smirk' },
  { id: 'serious', name: 'SÃ©rieux', icon: 'ðŸ˜¤', eyebrows: 'frown', eyes: 'narrow', mouth: 'straight' },
  { id: 'friendly', name: 'Amical', icon: 'ðŸ¤—', eyebrows: 'raised', eyes: 'open', mouth: 'wide_smile' },
  { id: 'thinking', name: 'Pensif', icon: 'ðŸ¤”', eyebrows: 'raised_one', eyes: 'look_up', mouth: 'pout' },
  { id: 'surprised', name: 'Surpris', icon: 'ðŸ˜®', eyebrows: 'high', eyes: 'wide', mouth: 'open' },
  { id: 'wink', name: 'Clin d\'Å“il', icon: 'ðŸ˜‰', eyebrows: 'raised_one', eyes: 'wink', mouth: 'smile' }
];

const ACCESSORIES = {
  eyewear: [
    { id: 'none', name: 'Aucun', icon: 'âŒ' },
    { id: 'glasses_round', name: 'Lunettes rondes', icon: 'ðŸ‘“' },
    { id: 'glasses_square', name: 'Lunettes carrÃ©es', icon: 'ðŸ¤“' },
    { id: 'glasses_cat', name: 'Cat-eye', icon: 'ðŸ˜º' },
    { id: 'sunglasses', name: 'Solaires', icon: 'ðŸ•¶ï¸' },
    { id: 'sunglasses_aviator', name: 'Aviator', icon: 'âœˆï¸' },
    { id: 'monocle', name: 'Monocle', icon: 'ðŸ§' }
  ],
  headwear: [
    { id: 'none', name: 'Aucun', icon: 'âŒ' },
    { id: 'cap', name: 'Casquette', icon: 'ðŸ§¢' },
    { id: 'beanie', name: 'Tuque', icon: 'ðŸ§¶' },
    { id: 'fedora', name: 'Fedora', icon: 'ðŸŽ©' },
    { id: 'hardhat', name: 'Casque chantier', icon: 'â›‘ï¸' },
    { id: 'crown', name: 'Couronne', icon: 'ðŸ‘‘' },
    { id: 'headphones', name: 'Ã‰couteurs', icon: 'ðŸŽ§' },
    { id: 'vr_headset', name: 'Casque VR', icon: 'ðŸ¥½' }
  ],
  jewelry: [
    { id: 'none', name: 'Aucun', icon: 'âŒ' },
    { id: 'earrings_stud', name: 'Boucles clou', icon: 'ðŸ’Ž' },
    { id: 'earrings_hoop', name: 'CrÃ©oles', icon: 'â­•' },
    { id: 'earrings_drop', name: 'Pendantes', icon: 'ðŸ’§' },
    { id: 'nose_ring', name: 'Piercing nez', icon: 'ðŸ‘ƒ' },
    { id: 'necklace', name: 'Collier', icon: 'ðŸ“¿' }
  ],
  facial: [
    { id: 'none', name: 'Aucun', icon: 'âŒ' },
    { id: 'beard_stubble', name: 'Barbe 3 jours', icon: 'ðŸ§”' },
    { id: 'beard_full', name: 'Barbe complÃ¨te', icon: 'ðŸ§”â€â™‚ï¸' },
    { id: 'beard_goatee', name: 'Bouc', icon: 'ðŸ' },
    { id: 'mustache', name: 'Moustache', icon: 'ðŸ‘¨' },
    { id: 'freckles', name: 'Taches de rousseur', icon: 'ðŸ”µ' },
    { id: 'beauty_mark', name: 'Grain de beautÃ©', icon: 'âš«' }
  ]
};

const ANIMAL_TYPES = [
  { id: 'cat', emoji: 'ðŸ±', name: 'Chat', colors: ['orange', 'black', 'white', 'gray', 'calico'] },
  { id: 'dog', emoji: 'ðŸ•', name: 'Chien', colors: ['golden', 'brown', 'black', 'white', 'spotted'] },
  { id: 'wolf', emoji: 'ðŸº', name: 'Loup', colors: ['gray', 'white', 'black'] },
  { id: 'fox', emoji: 'ðŸ¦Š', name: 'Renard', colors: ['orange', 'arctic', 'silver'] },
  { id: 'bear', emoji: 'ðŸ»', name: 'Ours', colors: ['brown', 'black', 'polar'] },
  { id: 'lion', emoji: 'ðŸ¦', name: 'Lion', colors: ['golden', 'white'] },
  { id: 'tiger', emoji: 'ðŸ¯', name: 'Tigre', colors: ['orange', 'white', 'golden'] },
  { id: 'rabbit', emoji: 'ðŸ°', name: 'Lapin', colors: ['white', 'brown', 'gray', 'black'] },
  { id: 'owl', emoji: 'ðŸ¦‰', name: 'Hibou', colors: ['brown', 'snowy', 'gray'] },
  { id: 'eagle', emoji: 'ðŸ¦…', name: 'Aigle', colors: ['golden', 'bald'] },
  { id: 'panda', emoji: 'ðŸ¼', name: 'Panda', colors: ['classic', 'red'] },
  { id: 'koala', emoji: 'ðŸ¨', name: 'Koala', colors: ['gray'] }
];

const MYTHIC_TYPES = [
  { id: 'dragon', emoji: 'ðŸ‰', name: 'Dragon', elements: ['fire', 'ice', 'shadow', 'nature'] },
  { id: 'phoenix', emoji: 'ðŸ”¥', name: 'PhÃ©nix', elements: ['fire', 'ice', 'cosmic'] },
  { id: 'unicorn', emoji: 'ðŸ¦„', name: 'Licorne', elements: ['white', 'dark', 'rainbow'] },
  { id: 'griffin', emoji: 'ðŸ¦…', name: 'Griffon', elements: ['golden', 'silver', 'shadow'] },
  { id: 'mermaid', emoji: 'ðŸ§œ', name: 'SirÃ¨ne', elements: ['ocean', 'coral', 'deep'] },
  { id: 'fairy', emoji: 'ðŸ§š', name: 'FÃ©e', elements: ['spring', 'autumn', 'winter', 'shadow'] },
  { id: 'wizard', emoji: 'ðŸ§™', name: 'Mage', elements: ['fire', 'ice', 'arcane', 'nature'] },
  { id: 'vampire', emoji: 'ðŸ§›', name: 'Vampire', elements: ['classic', 'royal', 'feral'] },
  { id: 'werewolf', emoji: 'ðŸº', name: 'Loup-garou', elements: ['gray', 'black', 'white'] },
  { id: 'elf', emoji: 'ðŸ§', name: 'Elfe', elements: ['wood', 'dark', 'high'] },
  { id: 'demon', emoji: 'ðŸ˜ˆ', name: 'DÃ©mon', elements: ['fire', 'shadow', 'frost'] },
  { id: 'angel', emoji: 'ðŸ˜‡', name: 'Ange', elements: ['light', 'guardian', 'fallen'] }
];

const ABSTRACT_SHAPES = [
  { id: 'sphere', name: 'SphÃ¨re', icon: 'ðŸ”µ' },
  { id: 'cube', name: 'Cube', icon: 'ðŸŸ¦' },
  { id: 'pyramid', name: 'Pyramide', icon: 'ðŸ”º' },
  { id: 'crystal', name: 'Cristal', icon: 'ðŸ’Ž' },
...
export default function AvatarBuilderPro() {
              ...
              <>
                <OptionSelector
                  ...
                  options={[
                    ...
                    { id: 'rounded', name: 'Arrondi', icon: 'ðŸ”²' }
                  ]}
  ...
  const tabs = [
    { id: 'style', label: 'ðŸŽ­ Style', visible: true },
    { id: 'face', label: 'ðŸ‘¤ Visage', visible: config.style === 'human' || config.style === 'cartoon' },
    { id: 'hair', label: 'ðŸ’‡ Cheveux', visible: config.style === 'human' || config.style === 'cartoon' },
    { id: 'accessories', label: 'âœ¨ Accessoires', visible: true },
    { id: 'background', label: 'ðŸŽ¨ Fond', visible: true }
  ].filter(t => t.visible);
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{
          ...
          <span>ðŸŽ¨</span> Avatar Builder Pro
        </h2>
