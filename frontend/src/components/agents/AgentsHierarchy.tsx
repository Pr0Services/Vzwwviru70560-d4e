    ...
    <div className="min-h-screen bg-gray-900 text-white p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold">CHE·NU™ Construction</h1>
            ...
            {selectedAgent ? (
              <>
                ...
                <div className="mt-4 space-y-4">
                  <div>
                    <h3 className="text-sm text-gray-400 mb-2">ðŸ“‹ ResponsabilitÃ©s</h3>
                  ...
                  <div>
                    <h3 className="text-sm text-gray-400 mb-2">ðŸ”§ Outils ({selectedAgent.tools.length})</h3>
                  ...
                  {selectedAgent.delegatesTo && (
                    <div>
                      <h3 className="text-sm text-gray-400 mb-2">ðŸ‘¥ DÃ©lÃ¨gue Ã </h3>
