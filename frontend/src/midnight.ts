/* =========================================
   CHEÂ·NU â€” MIDNIGHT THEME
   
   ThÃ¨me sombre nocturne avec accents violets.
   ========================================= */
...
export const midnightTheme: ThemeConfig = {
  id: 'midnight',
  name: 'Midnight',
  description: 'ThÃ¨me nocturne profond avec accents violets mystÃ©rieux',
  ...
  agents: {
    ...
    l3: '#6d28d9',  // SpÃ©cialistes - Violet profond
  },
