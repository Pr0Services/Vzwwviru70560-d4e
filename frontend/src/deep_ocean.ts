/* =========================================
   CHEÂ·NU â€” DEEP OCEAN THEME
   
   ThÃ¨me aquatique profond avec tons bleus.
   ========================================= */
...
export const deepOceanTheme: ThemeConfig = {
  id: 'deep_ocean',
  name: 'Deep Ocean',
  description: 'ThÃ¨me aquatique profond aux tons bleus apaisants',
  ...
  agents: {
    ...
    l3: '#006064',  // SpÃ©cialistes - Bleu profond
  },
