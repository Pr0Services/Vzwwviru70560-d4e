...
/**
 * Universe Page â€” Root level view.
...
/**
 * Sphere Page â€” First level view.
...
export const AdaptivePageRouter: React.FC<AdaptivePageRouterProps> = ({
  ...
  // This proves that page type doesn't matter â€” only depth and content do
