/* =====================================================
   ...
   guarantees of CHEÂ·NU so that no future evolution,
...
/**
 * The default CHEÂ·NU foundation manifest.
...
export const CHENU_FOUNDATION_MANIFEST: FoundationManifest = {
  metadata: {
    ...
    originators: ['CHEÂ·NU Human Originators'],
  },
  ...
  declarations: [
    ...
    {
      id: 'D005',
      clause: 'Any derivative that violates the foundation is not CHEÂ·NU.',
      binding: true,
    },
  ],
};
