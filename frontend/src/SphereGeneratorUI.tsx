  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <div>
          <h2 style={styles.title}>ðŸŒ³ Create a Sphere</h2>
          <p style={styles.subtitle}>CHEÂ·NU â€” Governed Intelligence Operating System</p>
        </div>
        <span style={styles.foundationBadge}>
          ðŸ”’ Foundation-Locked
        </span>
      </div>
      ...
      <div style={styles.section}>
        <div style={styles.sectionTitle}>ðŸ›¡ï¸ Foundation Protections (Auto-Applied)</div>
        <div style={styles.protectionsList}>
          <div style={styles.protectionItem}>âœ… Foundation inheritance</div>
          <div style={styles.protectionItem}>âœ… Privacy inheritance</div>
          <div style={styles.protectionItem}>âœ… Human data ownership</div>
          <div style={styles.protectionItem}>âœ… Private by default</div>
          <div style={styles.protectionItem}>âœ… Reversibility enabled</div>
          <div style={styles.protectionItem}>âœ… No urgency patterns</div>
          <div style={styles.protectionItem}>âŒ Profiling forbidden</div>
          <div style={styles.protectionItem}>âŒ Implicit memory forbidden</div>
          <div style={styles.protectionItem}>âŒ Cross-sphere observation forbidden</div>
          <div style={styles.protectionItem}>âœ… Never interprets identity</div>
        </div>
      </div>
      ...
      {validation.errors.length > 0 && (
        <div style={styles.errorsBox}>
          {validation.errors.map(err => (
            <div key={err} style={styles.errorItem}>â€¢ {err}</div>
          ))}
        </div>
      )}
      ...
      {validation.warnings.length > 0 && (
        <div style={styles.warningsBox}>
          {validation.warnings.map(warn => (
            <div key={warn} style={styles.warningItem}>âš ï¸ {warn}</div>
          ))}
        </div>
      )}
  ...
  2
      ...
      {generated && (
        <div style={{ ...styles.section, marginTop: 24, background: '#d4edda' }}>
          <div style={styles.sectionTitle}>âœ… Sphere Generated Successfully</div>
