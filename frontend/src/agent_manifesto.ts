/* =========================================
   CHEÂ·NU â€” AGENT TYPES (From Agent Manifesto)
   
   Types pour les agents selon le manifeste.
   
   ðŸ“œ CORE LAWS (ABSOLUTE):
...
/** VÃ©rifier si une phrase est autorisÃ©e */
...
/** VÃ©rifier si une action viole les lois */
...
/** VÃ©rifier les conditions de succÃ¨s */
