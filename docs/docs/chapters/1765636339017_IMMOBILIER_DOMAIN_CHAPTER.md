# IMMOBILIER DOMAIN — COMPLETE SPECIFICATION

## Chapter 61: Immobilier Domain Overview

### Introduction

The Immobilier Domain represents CHE·NU's comprehensive property management capability, designed to handle the complete lifecycle of real estate ownership, rental operations, and property development. Unlike other domains that exist within single spheres, Immobilier operates as a **cross-sphere domain**, functioning differently within Personal (MAISON) and Enterprise (ENTREPRISE) contexts while maintaining unified data structures and agent architectures.

### Domain Definition

The Immobilier Domain is CHE·NU's dedicated property management system. It is NOT a sphere—it is a specialized domain that manifests within existing spheres:
...
Every property within CHE·NU exists as its own dedicated DataSpace. This architectural decision ensures that all information related to a property remains contextually connected while enabling sophisticated cross-property analysis and reporting.
...
├── [All Personal Structure Elements]
├── 👥 Tenants/
│   ├── [Unit_101]/
│   │   ├── tenant_profile.json
│   │   ├── lease_agreement.pdf
...
The Immobilier Domain integrates deeply with CHE·NU's DataSpace Engine through:
...
The Immobilier Domain implements a specialized agent hierarchy following CHE·NU's L0-L3 governance structure:

### L3 — Domain Coordinator Agent
...
All Immobilier agents operate within CHE·NU's governance framework:
...
The Immobilier Domain integrates with all major CHE·NU engines:
...
The Immobilier Domain leverages CHE·NU's XR Spatial Engine for powerful property visualization:
...
The Immobilier Domain creates rich connections across CHE·NU's ecosystem:
...
**TAL**: Tribunal administratif du logement — Quebec's rental housing tribunal.

**RBQ**: Régie du bâtiment du Québec — Quebec's construction regulatory body.

**XR Scene**: Extended Reality visualization of a property space.

**Property Onboarding**: Workflow for adding a new property to CHE·NU.
