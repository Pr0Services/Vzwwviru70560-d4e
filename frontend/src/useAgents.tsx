/* =========================================
   CHEÂ·NU â€” useAgents Hook
   
   Hook React pour interagir avec le systÃ¨me d'agents.
...
export function useAgents() {
  ...
  /**
   * Consulter un agent spÃ©cifique
   */
  ...
  /**
   * VÃ©rifier si l'orchestrator est actif
   */
  ...
  /**
   * Obtenir le rapport de conformitÃ©
   */
