...
const sections = [
  { id: 'dashboard', label: 'Dashboard', icon: 'ðŸ“Š', path: '/entreprise/dashboard' },
  { id: 'projets', label: 'Projets', icon: 'ðŸ“', path: '/entreprise/projets' },
  { id: 'taches', label: 'TÃ¢ches', icon: 'âœ…', path: '/entreprise/taches' },
  { id: 'equipe', label: 'Ã‰quipe', icon: 'ðŸ‘¥', path: '/entreprise/equipe' },
  { id: 'clients', label: 'Clients', icon: 'ðŸ¤', path: '/entreprise/clients' },
  { id: 'fournisseurs', label: 'Fournisseurs', icon: 'ðŸ­', path: '/entreprise/fournisseurs' },
  { id: 'comptabilite', label: 'ComptabilitÃ©', icon: 'ðŸ’°', path: '/entreprise/comptabilite' },
  { id: 'documents', label: 'Documents', icon: 'ðŸ“„', path: '/entreprise/documents' },
  { id: 'conformite', label: 'ConformitÃ© QC', icon: 'ðŸ', path: '/entreprise/conformite' },
];
...
function ConformiteQC() {
  return (
    <div>
      <h2 style={{ fontSize: 18, fontWeight: 600, color: '#e8e4dc', margin: '0 0 20px' }}>ðŸ ConformitÃ© QuÃ©bec</h2>
