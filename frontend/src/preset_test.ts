/* =========================================
   CHEÂ·NU â€” PRESET SYSTEM TESTS
   
   Tests pour le systÃ¨me de presets.
   VÃ©rifie le respect des 5 Lois.
   ========================================= */
...
describe('CHEÂ·NU Preset System', () => {
  ...
  describe('Timeline (Source de VÃ©ritÃ©)', () => {
  ...
  describe('Explain (Transparence)', () => {
    ...
    it('should generate session summary', () => {
      ...
      expect(summary).toContain('RÃ©sumÃ© de session');
  ...
  describe('5 Lois des Presets', () => {
    it('LOI 1: Timeline = vÃ©ritÃ© absolue', () => {
    ...
    it('LOI 2: XR = visualisation, jamais dÃ©cision', () => {
    ...
    it('LOI 5: Humain > systÃ¨me, toujours', () => {
      // Manual has highest priority
      expect(PRESET_PRIORITY[0]).toBe('manual');
      
      // Laws are immutable
      expect(PRESET_LAWS).toContain('Humain > systÃ¨me, toujours');
