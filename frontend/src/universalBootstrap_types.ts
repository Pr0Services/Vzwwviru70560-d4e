/* =====================================================
   ...
   that governs ALL agents operating within CHEÂ·NU.
...
/* =========================================================
   UNIVERSAL BOOTSTRAP â€” CORE PROTOCOL
   ========================================================= */
...
export interface UniversalBootstrap {
  /** Protocol metadata */
  metadata: {
    name: 'CHEÂ·NU Universal Bootstrap';
    authority: 'FOUNDATION-LOCKED';
    mode: 'READ & OBEY';
    version: string;
  };
...
export const UNIVERSAL_BOOTSTRAP: UniversalBootstrap = {
  ...
  systemContext: `You are operating inside the CHEÂ·NU system.
...
and convenience.`,
  ...
  coreValue: 'CHEÂ·NU values integrity over capability.',
};
...
export const INTERNAL_AGENT_BOOTSTRAP: InternalAgentBootstrap = {
  ...
  role: `You are an internal agent of CHEÂ·NU.
...
export function generateUniversalBootstrapText(): string {
  return `CHEÂ·NU â€” UNIVERSAL BOOTSTRAP
Authority: FOUNDATION-LOCKED
Mode: READ & OBEY
...
export function generateContextualBootstrapText(ctx: ContextualBootstrap): string {
  return `CHEÂ·NU â€” CONTEXTUAL BOOTSTRAP EXTENSION
Scope: ${ctx.scope}
...
export function generateInternalAgentBootstrapText(): string {
  return `CHEÂ·NU â€” INTERNAL AGENT BOOTSTRAP
...
â†’ cease operation
â†’ report integrity failure
â†’ await human instruction
